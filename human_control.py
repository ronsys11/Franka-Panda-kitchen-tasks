...
if __name__ == '__main__':
    ...
    print(f"starting memory size: {starting_memory_size}")
    ...
    while running:
        ...
        while not done and episode_step < max_episode_steps and running:
            ...
            if action is not None:
                ...
                print(f"Episode step: {episode_step} Reward: {reward} Successfully added {memory.mem_ctr - starting_memory_size} Steps to memory. Total: {memory.mem_ctr}")
                state = next_state
                episode_step += 1
