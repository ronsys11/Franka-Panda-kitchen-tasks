...
class Agent(object):
    ...
    def update_parameters(self, memory : ReplayBuffer, batch_size, updates):
        ...
        alpha_tlogs = torch.torch.tensor(self.alpha)
    ...
    def test(self, env : RoboGymObservationWrapper, episodes = 1, max_episode_steps = 1500 , prev_action = None):
        ...
        for episode in range(episodes):
            ...
            print("Episode: {}, episode steps: {}, reward: {}".format(episode, episode_steps, round(episode_reward, 2)))
    ...
    def load_checkpoint(self, evaluate = False):
        ...
        try:
            ...
            if evaluate:
                raise Exception("Models cant be loaded")
            else:
                print("Models cant be loaded so training from scratch")
