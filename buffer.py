...
class ReplayBuffer():
    ...
    def sample_buffer(self, batch_size):
        ...
        if self.augment_data:
            ...
            states += np.random.normal(0, state_noise_std, size=states.shape)
            actions += np.random.normal(0, action_noise_std, size=actions.shape)
    ...
    def load_from_csv(self,filename, expert_data = True):
        try:
            ...
            print("Loaded {} transitions from {}".format(self.mem_ctr, filename))
